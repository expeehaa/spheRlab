...
// slplotfieldloop
void slplotfieldloop(List plotinitres, arma::mat lonv, arma::mat latv, List colbar, IntegerVector colind, String colfill, String colborder, double borderlwd, int borderlty, int threads);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< arma::mat >::type lonv(lonvSEXP);
    Rcpp::traits::input_parameter< arma::mat >::type latv(latvSEXP);
